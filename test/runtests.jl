...
@testset "Day 21" begin
    @test AdventOfCode2015.Day21.day21() == [91, 158]
end

@testset "Day 22" begin
    @test AdventOfCode2015.Day22.day22() == [953, 1289]
end

@testset "Day 23" begin
    @test AdventOfCode2015.Day23.day23() == [170, 247]
end

@testset "Day 24" begin
    @test AdventOfCode2015.Day24.day24() == [11266889531, 77387711]
end

@testset "Day 25" begin
    @test AdventOfCode2015.Day25.day25() == 9132360
end